...
class ImageLabelSync:
    def __init__(self, folder):
        self.folder = folder
        self.images_folder = '{}/images/train2014'.format(folder)
        self.labels_folder = '{}/labels/train2014'.format(folder)
...
def main():
    ...
    #     img_label_sync.run()
    # folder = '/media/taka/dataset/river_data/fake_pillar'
    folder = '/media/taka/dataset/coco'
    img_label_sync = ImageLabelSync(folder=folder)
    img_label_sync.run()
